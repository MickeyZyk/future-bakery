          ...
          <div id="video_image_anchor" className={s.detail_wrapper}>
            ...
            <div className={s.row__threebot} ref={this.videoOverlay}>
              <div className={s.column__col7}>
                <If condition={this.props.data.gravCrowdersWork.video != 'null'}>
                  <Then>
                    <img className={s.client_logo} src={ 'http://futurebakery.appio.cz/grav/en/crowders/work/'+ slug(this.props.data.gravCrowdersWork.title.toLowerCase()) + '/' + this.props.data.gravCrowdersWork.logo_light } />              
                  </Then>
                  <Else>
            ...
            <img id="video_image" src={ 'http://futurebakery.appio.cz/grav/en/crowders/work/'+ slug(this.props.data.gravCrowdersWork.title.toLowerCase()) + '/' + this.props.data.gravCrowdersWork.big_image } ref={this.videoPreview} className={s.fiat_img} />
