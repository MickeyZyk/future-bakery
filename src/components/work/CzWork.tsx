        ...
        <div className={s.row}>
          <div className={s.row__one}>
            ...
            <div className={s.column__col1}>
                    ...
                    <img className={s.client_logo} src={ 'https://futurebakery.cz/grav/cz/czbakers/work/'+ slug(this.props.data.gravBakersCzWork.title.toLowerCase()) + '/' + this.props.data.gravBakersCzWork.logo_dark } />
                    <>
          ...
          return (
            ...
            <div className={s.row__threebot} ref={this.videoOverlay}>
              <div className={s.column__col7}>
                <img className={s.client_logo} src={ 'https://futurebakery.cz/grav/cz/czbakers/work/'+ slug(this.props.data.gravBakersCzWork.title.toLowerCase()) + '/' + this.props.data.gravBakersCzWork.logo_light } />              
            ...
            <img id="video_image" src={ 'https://futurebakery.cz/grav/cz/czbakers/work/'+ slug(this.props.data.gravBakersCzWork.title.toLowerCase()) + '/' + this.props.data.gravBakersCzWork.big_image } ref={this.videoPreview} className={s.fiat_img} />
