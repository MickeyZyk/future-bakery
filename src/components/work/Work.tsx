        ...
        <div className={s.row}>
          <div className={s.row__one}>
            ...
            <div className={s.column__col1}>
                    ...
                    <img className={s.client_logo} src={ 'http://futurebakery.cz/grav/en/bakery/work/'+ slug(this.props.data.gravBakeryWork.title.toLowerCase()) + '/' + this.props.data.gravBakeryWork.logo_dark } />
                    <>
      ...
      <TransitionState>
        {({ transitionStatus, ...props }) => {
          return (
            ...
            <img id="video_image" src={ 'http://futurebakery.cz/grav/en/bakery/work/'+ slug(this.props.data.gravBakeryWork.title.toLowerCase()) + '/' + this.props.data.gravBakeryWork.big_image } ref={this.videoPreview} className={s.fiat_img} />
