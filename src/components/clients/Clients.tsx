  ...
  render() {
    ...
    return (
        ...
        <Row style={{maxHeight: '54vw'}}>
            ...
            <img src="../images/about_fiat_logo.png" className="whom_03" ref={this.image_03}/>

            <img src="../images/about_nike_logo.png" className="whom_01" ref={this.image_04}/>
            ...
            <img src="../images/about_fiat_logo.png" className="whom_01" ref={this.image_07}/>
            <img src="../images/about_nike_logo.png" className="whom_02" ref={this.image_08}/>
            <img src="../images/about_fiat_logo.png" className="whom_03" ref={this.image_09}/>      



            <img src="../images/about_nike_logo.png" className="whom_01 b_image" ref={this.imageb_01}/>
            <img src="../images/about_fiat_logo.png" className="whom_02 b_image" ref={this.imageb_02}/>
            ...
            <img src="../images/about_nike_logo.png" className="whom_02 b_image" ref={this.imageb_05}/>
            <img src="../images/about_fiat_logo.png" className="whom_03 b_image" ref={this.imageb_06}/>
            ...
            <img src="../images/about_nike_logo.png" className="whom_03 b_image" ref={this.imageb_09}/>      
