...
const BakersAbout = ({ data, className }) => {
 ...
 function getMembers(item) {
  ...
  function getImages(item) {
    var image = ['https://future.stratego.ba/cz/czbakers/pages/'  + slug(data.gravBakersCzAbout.title.toLowerCase()) + '/' + item.image];
    return image;
  }  
  ...
  <div className='wrapper about-wrapper'>
    ...
    <ReactCursorPosition>
            ...
            to={ ['exiting'].includes(transitionStatus) ? { yPercent: -100, ease: 'Power3.easeInOut' } : false  } >  
              <div>
                ...
                <Row>
                    ...
                    <Figure 
                    src={ 'https://future.stratego.ba/cz/czbakers/pages/'+ slug(data.gravBakersCzAbout.title.toLowerCase()) + '/' + data.gravBakersCzAbout.image_one } 
      ...
      <ReactCursorPosition>
              ...
              <Row>
                <Figure
                src={ 'https://future.stratego.ba/cz/czbakers/pages/'+ slug(data.gravBakersCzAbout.title.toLowerCase()) + '/' + data.gravBakersCzAbout.image_two } 
      ...
      <SVGicon className='bakers_about_treasure' src='treasure.svg' />
        ...
        <Row className="bakers_about_steps_two">
          ...
          {data.gravBakersCzAbout.svg_icons.map((svg, i) => (
            ...
            src={ 'https://future.stratego.ba/cz/czbakers/pages/'+ slug(data.gravBakersCzAbout.title.toLowerCase()) + '/' + svg.svg }
            />       
          ))}
  ...
  <ReactCursorPosition>
      ...
      <SVGiconReverse className='bakers_about_book' src='book.svg' />         
        ...
        <Row className="bakers_about_authors">
          ...
          <SmallFigure
          src={ 'https://future.stratego.ba/cz/czbakers/pages/'+ slug(data.gravBakersCzAbout.title.toLowerCase()) + '/' + data.gravBakersCzAbout.authors_image } 
