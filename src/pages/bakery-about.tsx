...
render() {
 ...
 function getMembers(item) {
  ...
  function getImages(item) {
    var image = ['https://futurebakery.cz/grav/en/bakery/pages/'  + titleSlug + '/' + item.image];
    return image;
  }  
                ...
                <div className='wrapper about-wrapper bakery-about-wrapper'>
                  <ReactCursorPosition>
                    ...
                    <Row>
                      ...
                      <Figure src={ 'https://futurebakery.cz/grav/user/pages/bakery/pages/about-us/' + this.props.data.gravBakeryAbout.image_one } 
