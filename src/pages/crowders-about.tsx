...
const CrowdersAbout = ({ data, className, state, transitionStatus }) => {
 ...
 function getMembers(item) {
  ...
  function getImages(item) {
    var image = ['https://futurebakery.cz/grav/en/crowders/pages/'  + slug(data.gravCrowdersAbout.title.toLowerCase()) + '/' + item.image];
    return image;
  }  
        ...
        <SVGiconReverse className='crowders_cheese' src='crowders_cheese.svg' />        
          ...
          <Row> 
            ...
            <div className="crowders_about_first_left">
              ...
              <ReverseFigure className='crowders_about_image responsive_image show_on_mobile' src={'https://futurebakery.cz/grav/en/crowders/pages/about-us/' + data.gravCrowdersAbout.image_one} />         
