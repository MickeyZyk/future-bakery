...
export default class CrowdersIndex extends React.Component {
  ...
  function getImages(item) {
    var image = ['https://futurebakery.cz/grav/en/crowders/' + item.node.image];
    return image;
  }     
          ...
          return (
            ...
            to={ ['exiting'].includes(transitionStatus) ? { yPercent: -200, opacity: 0, ease: 'Power3.easeInOut' } : false  } > 
                ...
                <div className="crowders_home_flip_button">
                  <Row>
                    <Link crowders arrow button className="home_cta_button" to={'/crowderscontact'}>START A PROJECT WITH US</Link>
                  </Row>
                </div>
