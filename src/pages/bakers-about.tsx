...
const BakersAbout = ({ data, className }) => {
 ...
 function getMembers(item) {
  ...
  function getImages(item) {
    var image = ['https://futurebakery.cz/grav/en/bakers/pages/'  + slug(data.gravBakersAbout.title.toLowerCase()) + '/' + item.image];
    return image;
  }  
  ...
  <div className='wrapper about-wrapper bakers-about-wrapper'>
    ...
    <ReactCursorPosition>
            ...
            to={ ['exiting'].includes(transitionStatus) ? { yPercent: -100, ease: 'Power3.easeInOut' } : false  } >  
              <div>
                ...
                <Row>
                    ...
                    <Figure 
                    src={ 'https://futurebakery.cz/grav/en/bakers/pages/'+ slug(data.gravBakersAbout.title.toLowerCase()) + '/' + data.gravBakersAbout.image_one } 
      ...
      <ReactCursorPosition>
              ...
              <Row>
                <Figure
                src={ 'https://futurebakery.cz/grav/en/bakers/pages/'+ slug(data.gravBakersAbout.title.toLowerCase()) + '/' + data.gravBakersAbout.image_two } 
     ...
     <Swipeable
        ...
        <Row className="bakers_about_steps_two">
          ...
          {data.gravBakersAbout.svg_icons.map((svg, i) => (
            ...
            src={ 'https://futurebakery.cz/grav/en/bakers/pages/'+ slug(data.gravBakersAbout.title.toLowerCase()) + '/' + svg.svg }
            />       
          ))}
    ...
    <ReactCursorPosition>
      ...
      <SVGiconReverse className='bakers_about_book' src='book.svg' />         
        ...
        <Row className="bakers_about_authors">
          ...
          <SmallFigure
          src={ 'https://futurebakery.cz/grav/en/bakers/pages/'+ slug(data.gravBakersAbout.title.toLowerCase()) + '/' + data.gravBakersAbout.authors_image } 
